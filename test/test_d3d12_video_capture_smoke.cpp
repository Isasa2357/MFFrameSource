...
MFTEST_MAIN({
    if (!HasRequiredSmokeEnv()) {
        std::cout << "SKIP: set MFFRAMESOURCE_TEST_VIDEO_PATH, VIDEO_WIDTH, VIDEO_HEIGHT, VIDEO_FPS_NUM, VIDEO_FPS_DEN, VIDEO_SUBTYPE, and MFFRAMESOURCE_D3D12_PROCESSING_SHADER_DIR to run video smoke test.\n";
        return 0;
    }
